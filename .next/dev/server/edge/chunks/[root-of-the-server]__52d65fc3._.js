(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__52d65fc3._.js",
...
async function middleware(request) {
    ...
    if (pathname.startsWith('/admin')) {
        ...
        if (roleRow.role === 'mobile_manager') {
            ...
            if (!inKpis) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin/kpis', request.url));
            }
            return response;
        }
        ...
        const locResult = await supabase.from('profiles').select('gift_card_location_config_id').eq('id', user.id).maybeSingle();
        ...
        if (locationConfigId) {
            const allowed = pathname === '/admin/giftcards/issue' || pathname === '/admin/giftcards/issued' || /^\/admin\/giftcards\/issued\/[^/]+\/print$/.test(pathname);
            if (!allowed) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin/giftcards/issue', request.url));
            }
        }
        return response;
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52d65fc3._.js.map