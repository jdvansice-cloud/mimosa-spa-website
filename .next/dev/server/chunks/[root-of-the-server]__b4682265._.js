...
async function GET(request) {
    ...
    const { data: upcoming } = await supabase.from('bookings').select('id, client_name, client_phone, location_id, location_name, appointment_start, mindbody_appointment_ids').eq('status', 'confirmed').gte('appointment_start', nowIso).lte('appointment_start', horizon).not('mindbody_appointment_ids', 'is', null);
    if (upcoming && upcoming.length > 0) {
        const upLocIds = [
            ...new Set(upcoming.map((b)=>b.location_id).filter(Boolean))
        ];
        ...
        for (const booking of upcoming){
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$wati$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isWatiConfigured"])() && booking.client_phone && booking.client_name) {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$wati$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendBookingCancellation"])({
                    ...
                    date: d.toLocaleDateString('es-PA', {
                        timeZone: 'America/Panama',
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric'
                    }),
                    time: d.toLocaleTimeString('es-PA', {
                        timeZone: 'America/Panama',
                        hour: 'numeric',
                        minute: '2-digit',
                        hour12: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4682265._.js.map