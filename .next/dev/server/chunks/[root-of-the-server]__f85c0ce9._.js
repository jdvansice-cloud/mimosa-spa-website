...
"[project]/src/app/api/mindbody/staff/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (sessionTypeIdsParam) {
            sessionTypeIds = sessionTypeIdsParam.split(',').map((id)=>parseInt(id.trim())).filter((id)=>!isNaN(id));
        }
        ...
        if (sessionTypeIds.length > 0) {
            ...
            staffMembers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStaffWithAvailability"])({
            ...
            staffMembers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStaff"])(parsedLocationId);
        }
        ...
        if (!Array.isArray(staffMembers)) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].STAFF_LOAD_FAILED
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f85c0ce9._.js.map