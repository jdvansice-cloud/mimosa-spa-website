...
"[project]/src/app/api/promotions/[id]/with-services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: promotion, error: promotionError } = await supabase.from('promotions').select('*').eq('id', id).eq('is_active', true).single();
        ...
        try {
            const onlineServices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOnlineBookableServicesForPromotions"])();
            ...
            const promotionServices = onlineServices.filter((service)=>promoIdStrings.has(String(service.Id)) || service.ProductId && promoIdStrings.has(String(service.ProductId)));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__042f4a1a._.js.map