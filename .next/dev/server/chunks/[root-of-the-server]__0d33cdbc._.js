...
"[project]/src/app/api/mindbody/auth/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    // Apply rate limiting
    const clientIdentifier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClientIdentifier"])(request);
    const rateLimitResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`auth:${clientIdentifier}`, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RATE_LIMIT_AUTH"]);
    if (!rateLimitResult.success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Demasiados intentos. Por favor espera un momento.'
        }, {
            status: 429,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRateLimitHeaders"])(rateLimitResult)
        });
    }
    try {
        ...
        if (!process.env.MINDBODY_API_KEY || !process.env.MINDBODY_SITE_ID) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].GENERIC_ERROR
            }, {
                status: 503
            });
        }
        ...
        if (action === 'register') {
            ...
            const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateRequired"])({
                firstName,
                lastName,
                email,
                phone
            ...
            if (!email.includes('@') || !email.includes('.')) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].INVALID_EMAIL
                }, {
                    status: 400
                });
            }
            ...
            if (phoneDigits.length < 8) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].INVALID_PHONE
                }, {
                    status: 400
                });
            }
            ...
            try {
                const byEmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchClients"])(email);
                const emailMatch = byEmail.find((c)=>c.Email?.toLowerCase() === email.toLowerCase());
                if (emailMatch) {
            ...
            try {
                const byPhone = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchClients"])(phone);
                const phoneMatch = byPhone.find((c)=>{
                    const mobileMatch = c.MobilePhone && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["phoneNumbersMatch"])(c.MobilePhone, phone);
                    const homeMatch = c.HomePhone && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["phoneNumbersMatch"])(c.HomePhone, phone);
            ...
            try {
                console.log('No existing client found, creating:', {
                    firstName,
                    lastName,
                    email,
                    phone
                });
                const client = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addClient"])({
                    FirstName: firstName,
                    LastName: lastName,
                    Email: email,
                    MobilePhone: phone,
                ...
                if (/duplicate client/i.test(errorMessage)) {
                    try {
                        const byEmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchClients"])(email);
                        const emailMatch = byEmail.find((c)=>c.Email?.toLowerCase() === email.toLowerCase());
                        const byPhone = emailMatch ? [] : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchClients"])(phone);
                        const phoneMatch = byPhone.find((c)=>{
                            const mobileMatch = c.MobilePhone && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["phoneNumbersMatch"])(c.MobilePhone, phone);
                            const homeMatch = c.HomePhone && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["phoneNumbersMatch"])(c.HomePhone, phone);
                            return mobileMatch || homeMatch;
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].REGISTRATION_FAILED,
        ...
        // Search for clients
        const clients = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchClients"])(searchText);
        // Filter based on search type for accuracy
        let filteredClients = clients;
        if (searchType === 'email') {
            // Exact email match (case-insensitive)
            filteredClients = clients.filter((c)=>c.Email?.toLowerCase() === searchText.toLowerCase());
        } else if (searchType === 'phone') {
            // Use improved phone matching from constants
            filteredClients = clients.filter((c)=>{
                const mobileMatch = c.MobilePhone && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["phoneNumbersMatch"])(c.MobilePhone, searchText);
                const homeMatch = c.HomePhone && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["phoneNumbersMatch"])(c.HomePhone, searchText);
                return mobileMatch || homeMatch;
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d33cdbc._.js.map