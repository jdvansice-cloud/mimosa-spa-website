...
async function GET() {
    try {
        ...
        const { data, error } = await supabase.from('site_settings').select('phone_costa_del_este, phone_san_francisco, email, whatsapp_number, whatsapp_message, weekday_open, weekday_close, weekend_open, weekend_close, instagram_url, facebook_url').limit(1);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__110a733e._.js.map