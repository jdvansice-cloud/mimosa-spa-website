...
"[project]/src/app/api/mindbody/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (forPromotions) {
            ...
            const allOnlineServices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOnlineBookableServicesForPromotions"])(parsedLocationId);
            // Validate API response
            if (!Array.isArray(allOnlineServices)) {
                console.error('Invalid Mindbody response: services is not an array');
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].SERVICES_LOAD_FAILED
                }, {
                    status: 500
                });
            }
            ...
            filteredServices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAddons"])(parsedLocationId);
        } else if (includeOffline) {
            // For menu pages - include ALL services (online and offline)
            const allServices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllServices"])(parsedLocationId);
            // Validate API response
            ...
            if (type === 'main') {
                ...
                filteredServices = allServices.filter((s)=>s.ProgramId !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROGRAM_IDS"].ADICIONALES);
            } else {
                // type === 'all'
            ...
            const onlineServices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServices"])(parsedLocationId);
            // Validate API response
            ...
            if (onlineServices.length > 0) {
                ...
                console.log('Categories found:', [
                    ...new Set(onlineServices.map((s)=>s.Category))
                ]);
                console.log('ProgramIds found:', [
                    ...new Set(onlineServices.map((s)=>s.ProgramId))
                ]);
            }
            if (type === 'main') {
                // Exclude Adicionales category
                filteredServices = onlineServices.filter((s)=>s.ProgramId !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROGRAM_IDS"].ADICIONALES);
            } else {
                // type === 'all'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54c50802._.js.map