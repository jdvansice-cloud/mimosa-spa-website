...
"[project]/src/lib/booking/eligibility.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getEligibilityRows",
    ()=>getEligibilityRows,
    "getV1EligibleResourcesPerService",
    ()=>getV1EligibleResourcesPerService,
    "isFootMassageBase",
    ()=>isFootMassageBase,
    "isV1EligibleResource",
    ()=>isV1EligibleResource,
    "parseResourceName",
    ()=>parseResourceName
]);
...
;
;
async function getEligibilityRows(sessionTypeIds, locationId) {
    ...
    while(offset < maxRows){
        const { data, error } = await supabase.from('service_resource_eligibility').select('session_type_id, location_id, resource_id, resource_name').in('session_type_id', sessionTypeIds).eq('location_id', locationId).eq('is_active', true).range(offset, offset + pageSize - 1);
...
function parseResourceName(name) {
    ...
    if (!m) return null;
    return {
        locCode: m[1].toUpperCase(),
        baseName: m[2].trim(),
        bedNumber: parseInt(m[3], 10)
    };
}
function isFootMassageBase(baseName) {
    return /^foot\s*massage$/i.test(baseName.trim());
}
function isV1EligibleResource(name) {
    const parsed = parseResourceName(name);
    if (!parsed) return false;
    if (isFootMassageBase(parsed.baseName)) return true;
    return parsed.bedNumber === 1;
}
async function getV1EligibleResourcesPerService(params) {
    const { sessionTypeIds, locationId } = params;
    const [rows, resources] = await Promise.all([
        getEligibilityRows(sessionTypeIds, locationId),
        params.resources ? Promise.resolve(params.resources) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getResources"])({
            includeInactive: false
        })
    ]);
    const v1ResourceIds = new Set();
...
"[project]/src/app/api/mindbody/availability/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/booking/mindbody.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/booking/constants.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$eligibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/booking/eligibility.ts [app-route] (ecmascript)");
...
async function GET(request) {
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`availability:${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClientIdentifier"])(request)}`, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RATE_LIMIT_STANDARD"]);
    if (!rl.success) {
    ...
    try {
        ...
        let v1EligibleResourceIds = new Set();
        if (ROOMS_AWARE_AVAILABILITY && serviceIdArray.length > 0) {
            try {
                const eligibilityMap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$eligibility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getV1EligibleResourcesPerService"])({
                    sessionTypeIds: [
                        serviceIdArray[0]
                    ],
        ...
        const allStaff = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStaff"])(parsedLocationId);
        const validStaffIds = allStaff.filter((s)=>s.Id > 0 && s.AppointmentTrn !== false).map((s)=>s.Id);
        ...
        let staffBlockedPeriods = new Map();
        ...
        const resourceBusyPeriods = new Map();
        if (validStaffIds.length > 0) {
            try {
                const scheduleItems = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getScheduleItems"])({
                    locationIds: [
                        parsedLocationId
                    ],
                ...
                for (const staff of scheduleItems){
                    ...
                    const debugWorkingHours = [];
                    const debugFreeBlocks = [];
                    ...
                    if (staff.Availabilities && staff.Availabilities.length > 0) {
                        for (const avail of staff.Availabilities){
                            ...
                            const availEnd = bookableEndCandidate && !isNaN(bookableEndCandidate.getTime()) && bookableEndCandidate > availStart ? bookableEndCandidate : new Date(avail.EndDateTime);
                            const effectiveEndLabel = bookableEndCandidate && !isNaN(bookableEndCandidate.getTime()) && bookableEndCandidate > availStart ? avail.BookableEndDateTime : avail.EndDateTime;
        ...
        if (availableItems.length === 0 && serviceIdArray.length > 0) {
            try {
                ...
                const rawBookableItems = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBookableItems"])({
        ...
        if (availableItems.length === 0) {
            try {
                const staffAvailability = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$mindbody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStaffAppointmentAvailability"])({
                    locationId: parsedLocationId,
        ...
        if (availableItems.length === 0) {} else {}
        // Validate API response
        if (!Array.isArray(availableItems)) {
            console.error('Invalid Mindbody response: availableItems is not an array');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].NO_AVAILABILITY
            }, {
                status: 500
            });
        }
        ...
        const staffAvailabilityByDate = new Map();
        ...
        for (const [dateKey, staffMap] of staffAvailabilityByDate.entries()){
            ...
            const staffWithMergedBlocks = new Map();
...
function subtractBlockedPeriods(availability, blockedPeriods) {
    if (blockedPeriods.length === 0) {
        return [
            availability
        ];
    ...
    return remainingBlocks.filter((block)=>block.end.getTime() - block.start.getTime() >= 15 * 60 * 1000);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__487793d8._.js.map