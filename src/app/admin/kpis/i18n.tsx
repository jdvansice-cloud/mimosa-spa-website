...
const EN: Record<string, string> = {
  ...
  'Neto y propinas atribuidos por la cita del mismo día del cliente · Solicitada = el cliente pidió a esa terapeuta · Fidelidad = clientes de hace 3–6 meses que volvieron con ella en 90 días (mín. 5)':
    "Net and tips attributed via the client's same-day appointment · Requested = the client asked for that therapist · Loyalty = clients from 3–6 months ago who rebooked her within 90 days (min. 5)",
  // agenda
  'Agenda': 'Schedule',
