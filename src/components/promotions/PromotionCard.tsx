...
import { formatPrice, formatDuration, formatDate, getLocalizedContent } from '@/lib/utils'
...
export function PromotionCard({ promotion, locale, onBook }: PromotionCardProps) {
  const t = useTranslations('promotions')

  const title = getLocalizedContent(promotion, 'title', locale)
  const description = getLocalizedContent(promotion, 'description', locale)
